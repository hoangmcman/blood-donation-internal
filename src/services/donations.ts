...
export const useUpdateDonationStatus = () => {
	...
	return useMutation({
		...
		onSuccess: (_, variables) => {
			...
			// Invalidate the specific donation request query
			queryClient.invalidateQueries({ queryKey: ["donationRequest", variables.id] });
			// Also invalidate all donation request queries to be safe
